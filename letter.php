...
<head>
    ...
    <title>Clearance Letter | JOMO KENYATTA UNIVERSITY OF AGRICULTURE AND TECHNOLOGY</title>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                          <div class="text-center article-title">
                            ...
                            <h1>
                            JOMO KENYATTA UNIVERSITY OF AGRICULTURE AND TECHNOLOGY, JUJA <img src="<?php echo $rowaccess['photo']; ?>" width="157" height="175"></h1>
                          </div>
                            ...
                            <p align="justify"><strong>ADMISSION NUMBER:</strong> <?php echo $rowaccess['matric_no']; ?></p>
