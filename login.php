...
$_SESSION['error']=' Invalid Password Please Contact Your Admin';
}
}else{
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                ...
                <h5 class="style3">Web Based Student Clearance system</h5>
                <h1 class="logo-name"><a href="index.php"><img src="images/jkuat-logo.png" alt="onlineclearance" width="246" height="111" border="0"> </a></h1>
            </div>
