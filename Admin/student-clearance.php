...
if(confirm("ARE YOU SURE YOU WISH TO CLEAR STUDENT WITH Registration No. " + " " + matric_no + " " + " FOR NYSC/GRADUATION ?"))
{
return  true;
}
else {return false;
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <th width="10%"><div align="center">Fullname</div></th>
                        ...
                        <th width="5%"><div align="center">Registration No</div></th>
